			...
			<div className='grid-manage'>
				...
				<div className="grid-manage-detail">
					...
					<div className="grid-manage-btn">
						<Link className='dogme i-round i-sabz round-small' to={{ pathname: `/manage/wareType/edit/${ this.props._id }` }}> ویرایش </Link>
						<Link className='dogme i-round i-abi round-small' to={`/manage/wareType/changepic/${ this.props._id }`}> تعویض تصویر </Link>
