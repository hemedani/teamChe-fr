...
import { addOtaghBazargani, otaghBazarganiUploadPic, ADD_OTAGH_BAZARGANI } from "../../actions";
...
class AddOtaghBazarganiModal extends Component {
  ...
  onSubmitForm({ name, enName, pic, picRef }) {
    this.props.addOtaghBazargani({ name, enName, pic, picRef }).then(resp => {
...
export default connect(
  mps,
  { addOtaghBazargani, otaghBazarganiUploadPic }
