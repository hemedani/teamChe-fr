...
import { userChangePic, UPDATE_USER } from '../../actions'
import _ from 'lodash'
import Loader from '../Utils/Loader'


class ChangeUserPicModal extends Component {
  constructor(props) {
    super(props)
    this.state = {
      file: '',
  ...
  handleSubmitPic(e) {
    ...
    this.props.userChangePic({ file, id })
...
export default connect(mps, { userChangePic })(ChangeUserPicModal);
