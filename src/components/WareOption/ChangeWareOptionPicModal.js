...
import { addWareOption, wareOptionChangePic, UPDATE_WARE_OPTION} from '../../actions'
import _ from 'lodash'
import Loader from '../Utils/Loader'

class ChangeWareOptionPic extends Component {
  constructor(props) {
    super(props)
    this.state = {
      file: '',
  ...
  handleSubmitPic(e) {
    ...
    this.props.wareOptionChangePic({ file, id })
...
export default connect(mps, { addWareOption, wareOptionChangePic })(ChangeWareOptionPic);
