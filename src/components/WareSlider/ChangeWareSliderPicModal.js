...
import { addWareSlider, wareSliderChangePic, UPDATE_WARESLIDER} from '../../actions'
import _ from 'lodash'
import Loader from '../Utils/Loader'

class ChangeWareSliderPic extends Component {
  constructor(props) {
    super(props)
    this.state = {
      file: '',
  ...
  handleSubmitPic(e) {
    ...
    this.props.wareSliderChangePic({ file, id })
...
export default connect(mps, { addWareSlider, wareSliderChangePic })(ChangeWareSliderPic);
