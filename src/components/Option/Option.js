...
import { removeOption, RU } from '../../actions';
            ...
            {this.directPic()}
					...
					<div className="grid-manage-detail">
						...
						<div className="grid-manage-btn">
							<Link className='dogme i-round i-sabz round-small' to={{ pathname: `/manage/option/edit/${ this.props._id }` }}> ویرایش </Link>
							<Link className='dogme i-round i-abi round-small' to={`/manage/option/changepic/${ this.props._id }`}> تعویض تصویر </Link>
...
export default connect(null, { removeOption })(Option);
