...
import { optionChangePic, UPDATE_OPTION} from '../../actions'
import _ from 'lodash'
import Loader from '../Utils/Loader'


class ChangeOptionPicModal extends Component {
  constructor(props) {
    super(props)
    this.state = {
      file: '',
  ...
  handleSubmitPic(e) {
    ...
    this.props.optionChangePic({ file, id })
        ...
        <div className='modal'>
          ...
          <form onSubmit={this.handleSubmitPic}>
            ...
            <div className='chapchin width-same'>
              {this.props.options.picLoading ? ( <div className='vorod-bargozari'> <Loader /> </div> ) :
...
const msp = ({ options }) => ({ options })

export default connect(msp, { optionChangePic })(ChangeOptionPicModal);
