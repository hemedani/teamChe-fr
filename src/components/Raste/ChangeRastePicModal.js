...
import { addRaste, rasteChangePic, UPDATE_CENTER_TYPE } from "../../actions";
import _ from "lodash";
import Loader from "../Utils/Loader";

class ChangeRastePic extends Component {
  constructor(props) {
    super(props);
    this.state = {
      file: "",
  ...
  handleSubmitPic(e) {
    ...
    this.props.rasteChangePic({ file, id }).then(resp => {
