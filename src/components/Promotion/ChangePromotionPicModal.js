...
import { addPromotion, promotionChangePic, UPDATE_PROMOTION} from '../../actions'
import _ from 'lodash'
import Loader from '../Utils/Loader'

class ChangePromotionPic extends Component {
  constructor(props) {
    super(props)
    this.state = {
      file: '',
  ...
  handleSubmitPic(e) {
    ...
    this.props.promotionChangePic({ file, id })
        ...
        <div className='modal'>
          ...
          <form onSubmit={this.handleSubmitPic}>
            ...
            <div className='chapchin width-same'>
              {this.props.promotions.picLoading ? ( <div className='vorod-bargozari'> <Loader /> </div> ) :
...
export default connect(mps, { addPromotion, promotionChangePic })(ChangePromotionPic);
