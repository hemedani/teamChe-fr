...
import { addOtaghAsnaf, otaghAsnafChangePic, UPDATE_CENTER_TYPE } from "../../actions";
import _ from "lodash";
import Loader from "../Utils/Loader";

class ChangeOtaghAsnafPic extends Component {
  constructor(props) {
    super(props);
    this.state = {
      file: "",
  ...
  handleSubmitPic(e) {
    ...
    this.props.otaghAsnafChangePic({ file, id }).then(resp => {
...
export default connect(
  mps,
  { addOtaghAsnaf, otaghAsnafChangePic }
)(ChangeOtaghAsnafPic);
