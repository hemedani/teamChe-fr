export const OstanSelectErr = "لطفا استان مورد نظر را انتخاب کنید";
export const CitySelectErr = "لطفا شهر مورد نظر را انتخاب کنید";
export const PolygonSelectErr = "لطفا محیط منطقه را هم با ابزار کنار نقشه بکشید";
export const ParishSelectErr = "لطفا محله مورد نظر را انتخاب کنید";
