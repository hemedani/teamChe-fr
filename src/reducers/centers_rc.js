  ...
  switch (action.type) {
    ...
    case GET_CENTERS_COUNT_ERR:
      return {
        ...state,
        countLoading: false,
        errors: { ...state.errors, countErr: "مشکلی در دریافت تعداد مراکز به وجود آمده است" }
      };
    ...
    case PICS_UPLOADED:
      return { ...state, picsUploaded: [...state.picsUploaded, { _id: action.payload._id, name: action.payload.name }] };
    default:
      return state;
  }
}
