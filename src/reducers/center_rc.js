...
let centerDef = {
  centerLoading: true,
  error: "",
  center: { location: { coordinates: [54.399883, 32.159084] } },
  qualityRateLoading: false,
  priceRateLoading: false,
  salsmanRateLoading: false,
  editedCenter: { pic: [], location: { coordinates: [54.399883, 32.159084] } },
  editedCenterLoading: false,
  licensePicUpload: false
};
...
export default function(state = centerDef, action) {
  switch (action.type) {
    ...
    case CENTER_LICENSE_PIC_UPLOAD_LOAD:
      return { ...state, licensePicUpload: true };
    case CENTER_LICENSE_PIC_UPLOAD:
      return { ...state, licensePicUpload: false };
    ...
    case CHANGE_QUALITY_RATE:
      return {
        ...state,
        qualityRateLoading: false,
        center: { ...state.center, TotalQualityRate: action.payload.TotalQualityRate }
      };
    ...
    case CHANGE_PRICE_RATE:
      return {
        ...state,
        priceRateLoading: false,
        center: { ...state.center, TotalPriceRate: action.payload.TotalPriceRate }
      };
    ...
    case CHANGE_SALESMAN_RATE:
      return {
        ...state,
        salsmanRateLoading: false,
        center: { ...state.center, TotalSalesmanRate: action.payload.TotalSalesmanRate }
      };
    case GET_CENTER:
    ...
    case CENTER_UPDATE:
      return { ...state, editedCenterLoading: false, editedCenter: action.payload, centerLoading: false };
